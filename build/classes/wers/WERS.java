...
import javax.swing.*;
// CHANGED for FACADE DECOUPLING IMPLEMENTATION //
import scenarios.FacadeScenario;
...
public class WERS extends javax.swing.JFrame {
	...
	*/
	...
	private void runTwoPlusAdminjButtonActionPerformed(ActionEvent evt) {
		...
		String [] args = new String[0];
                // CHANGED for FACADE DECOUPLING IMPLEMENTATION //
		FacadeScenario.twoViewAdmin(args);
	}
